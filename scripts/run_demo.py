...
def run_bayesian_optimization():
    ...
    cmd = [
        ...
        "--config", DEMO_CONFIG,
        "--n-iterations", "3",  # Very short run
        "--data-dir", DATA_DIR,
        "--output-dir", "analysis_results/demo/bayesian"
    ]
...
def run_cross_validation():
    ...
    cmd = [
        ...
        "--subjects", "3",
        "--data-dir", DATA_DIR,
        "--output-dir", "analysis_results/demo/cv"
    ]
...
def main():
    ...
    print("This script will guide you through a demonstration of the OptiConn pipeline.")
    ...
    print("  python scripts/bayesian_optimizer.py --config configs/production_config.json")
    print("\n")

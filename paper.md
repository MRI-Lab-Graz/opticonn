...
-   License: MIT
-   Dependencies: Python ≥3.10, MRtrix3 (recommended) or DSI Studio, scikit-optimize, numpy/pandas/networkx/scipy.
-   **Demo Data**: To facilitate testing and demonstration, we provide a dedicated demo script (`scripts/opticonn_mrtrix_demo.py`) that uses `openneuro-py` to download a subset of the open-access "Slackline" dataset (ds003138) [https://openneuro.org/datasets/ds003138/versions/1.0.1](https://openneuro.org/datasets/ds003138/versions/1.0.1). This demo focuses on the optimization workflow, skipping heavy preprocessing to allow for rapid evaluation by reviewers.
